# 2025-07-01 07:13:16 by RouterOS 7.20beta4
...
/interface ethernet set [ find default-name=qsfp28-2-1 ] auto-negotiation=no l2mtu=9100 mtu=9000
...
/interface bridge port add bridge=bridge ingress-filtering=no interface=qsfp28-2-1
/interface bridge port add bridge=bridge ingress-filtering=no interface=qsfp28-3-1
/interface bridge port add bridge=bridge ingress-filtering=no interface=qsfp28-4-1
...
/ip address add address=160.22.181.183 disabled=yes interface=bridge network=160.22.181.183
/ip address add address=10.155.254.30/24 interface=vlan400-bgp network=10.155.254.0
