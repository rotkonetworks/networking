# 2026-08-12 15:06:49 by RouterOS 7.22
...
/ip firewall filter add action=accept chain=forward dst-port=32807 protocol=tcp
/ip firewall filter add action=accept chain=forward dst-port=10807 protocol=tcp
...
/ip firewall filter add action=accept chain=forward dst-port=10804 protocol=tcp
/ip firewall filter add action=accept chain=forward dst-port=32803 protocol=tcp
/ip firewall filter add action=accept chain=forward dst-port=10803 protocol=tcp
/ip firewall filter add action=accept chain=forward dst-port=32802 protocol=tcp
/ip firewall filter add action=accept chain=forward dst-port=10802 protocol=tcp
/ip firewall filter add action=accept chain=forward dst-port=32801 protocol=tcp
/ip firewall filter add action=accept chain=forward dst-port=22801 protocol=tcp
/ip firewall filter add action=accept chain=forward dst-port=10801 protocol=tcp
...
/ip firewall filter add action=drop chain=input comment="ephemerals runner - Block VM to router 192.168" dst-address=192.168.0.0/16 src-address=160.22.181.254
/ip firewall filter add action=drop chain=input comment="ephemerals runner - Block VM to router 10.x" dst-address=10.0.0.0/8 src-address=160.22.181.254
/ip firewall filter add action=drop chain=input comment="ephemerals runner - Block VM to router 172.16-31" dst-address=172.16.0.0/12 src-address=160.22.181.254
/ip firewall filter add action=drop chain=forward comment="ephemerals runner - Block VM to 192.168" dst-address=192.168.0.0/16 src-address=160.22.181.254
/ip firewall filter add action=drop chain=forward comment="ephemerals runner - Block CGNAT to local 192.168" dst-address=192.168.0.0/16 src-address=100.64.0.0/24
/ip firewall filter add action=drop chain=forward comment="ephemerals runner - Block VM to 10.x" dst-address=10.0.0.0/8 src-address=160.22.181.254
/ip firewall filter add action=drop chain=forward comment="ephemerals runner - Block CGNAT to local 10.x" dst-address=10.0.0.0/8 src-address=100.64.0.0/24
/ip firewall filter add action=drop chain=forward comment="ephemerals runner - Block VM to 172.16-31" dst-address=172.16.0.0/12 src-address=160.22.181.254
/ip firewall filter add action=drop chain=forward comment="ephemerals runner - Block CGNAT to local 172.16-31" dst-address=172.16.0.0/12 src-address=100.64.0.0/24
/ip firewall filter add action=accept chain=forward comment="ephemerals runner - Allow VM to internet" src-address=160.22.181.254
/ip firewall filter add action=drop chain=forward comment="ephemerals runner - Block local to CGNAT" dst-address=100.64.0.0/24 src-address=192.168.0.0/16
/ip firewall filter add action=drop chain=forward comment="ephemerals runner - Block local to CGNAT" dst-address=100.64.0.0/24 src-address=10.0.0.0/8
...
/ip firewall nat add action=dst-nat chain=dstnat comment=haproxy-bkk07 dst-address=160.22.181.18 dst-port=80 protocol=tcp to-addresses=192.168.77.91 to-ports=80
/ip firewall nat add action=dst-nat chain=dstnat comment=haproxy-bkk07 dst-address=160.22.181.18 dst-port=443 protocol=tcp to-addresses=192.168.77.91 to-ports=443
/ip firewall nat add action=dst-nat chain=dstnat comment=haproxy-bkk06 dst-address=160.22.181.18 dst-port=80 protocol=tcp to-addresses=192.168.76.91 to-ports=80
/ip firewall nat add action=dst-nat chain=dstnat comment=haproxy-bkk06 dst-address=160.22.181.18 dst-port=443 protocol=tcp to-addresses=192.168.76.91 to-ports=443
/ip firewall nat add action=dst-nat chain=dstnat comment=haproxy-bkk08 dst-address=160.22.181.18 dst-port=80 protocol=tcp to-addresses=192.168.78.91 to-ports=80
/ip firewall nat add action=dst-nat chain=dstnat comment=haproxy-bkk08 dst-address=160.22.181.18 dst-port=443 protocol=tcp to-addresses=192.168.78.91 to-ports=443
...
/ip firewall nat add action=dst-nat chain=dstnat dst-address=160.22.181.181 dst-port=22789 protocol=tcp to-addresses=192.168.79.1 to-ports=22
...
/ip firewall nat add action=dst-nat chain=dstnat dst-address=172.30.50.39 dst-port=80 protocol=tcp to-addresses=192.168.79.1 to-ports=80
/ip firewall nat add action=dst-nat chain=dstnat dst-address=172.30.50.39 protocol=tcp to-addresses=192.168.79.1
...
/ip firewall nat add action=dst-nat chain=dstnat dst-address=160.22.181.181 dst-port=39111 protocol=tcp to-addresses=192.168.79.1 to-ports=39111
/ip firewall nat add action=dst-nat chain=dstnat dst-address=160.22.181.181 dst-port=39112 protocol=tcp to-addresses=192.168.79.1 to-ports=39112
/ip firewall nat add action=dst-nat chain=dstnat dst-address=160.22.181.181 dst-port=39113 protocol=tcp to-addresses=192.168.79.1 to-ports=39113
/ip firewall nat add action=dst-nat chain=dstnat dst-address=160.22.181.181 dst-port=39121 protocol=tcp to-addresses=192.168.79.1 to-ports=39121
/ip firewall nat add action=dst-nat chain=dstnat dst-address=160.22.181.181 dst-port=39122 protocol=tcp to-addresses=192.168.79.1 to-ports=39122
/ip firewall nat add action=dst-nat chain=dstnat dst-address=160.22.181.181 dst-port=39123 protocol=tcp to-addresses=192.168.79.1 to-ports=39123
...
/ip firewall nat add action=dst-nat chain=dstnat dst-address=160.22.181.181 dst-port=32801 protocol=tcp to-addresses=192.168.78.201 to-ports=22
/ip firewall nat add action=dst-nat chain=dstnat dst-address=160.22.181.181 dst-port=32802 protocol=tcp to-addresses=192.168.78.202 to-ports=22
...
/ip firewall nat add action=dst-nat chain=dstnat dst-address=160.22.181.181 dst-port=32807 protocol=tcp to-addresses=192.168.77.207 to-ports=22
/ip firewall nat add action=src-nat chain=srcnat dst-address=!172.16.0.0/12 out-interface-list=WAN src-address=172.16.20.2 to-addresses=160.22.181.181
/ip firewall nat add action=src-nat chain=srcnat dst-address=!172.16.0.0/12 out-interface-list=WAN src-address=172.16.10.2 to-addresses=160.22.181.181
...
/routing ospf interface-template add area=backbone-v6 comment=sax-v6 disabled=no networks=2401:a860:169::/64 passive
