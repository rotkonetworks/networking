# 2026-07-17 16:01:21 by RouterOS 7.22
...
/interface vlan add interface=HGC-10G-SG-BKK20-LAG name=vAMSIX-BKK vlan-id=911
...
/routing bgp instance add as=142108 disabled=no name=bgp-instance-1 router-id=10.155.255.2 vrf=main
/routing bgp template add afi=ipv6 input.filter=iBGP-IN-v6 multihop=yes name=IBGP-ROTKO-v6 nexthop-choice=force-self output.filter-chain=iBGP-OUT-v6 .network=ipv6-apnic-rotko .redistribute=connected,static,bgp
...
/routing bgp template add afi=ip disabled=no input.filter=HGC-HK-IN-v4 multihop=yes name=IPTX-HGC-TH-HK-v4 output.as-override=no .filter-chain=HGC-HK-OUT-v4 .keep-sent-attributes=yes .network=ipv4-apnic-rotko .remove-private-as=yes routing-table=main
...
/interface bridge port add bridge=bridge_vlan frame-types=admit-only-vlan-tagged interface=sfp28-12 pvid=400
...
/interface bridge vlan add bridge=bridge_vlan tagged=BKK10-LAG,BKK40-LAG,sfp28-12 vlan-ids=400
...
/interface list member add interface=HGC-10G-SG-BKK20-LAG list=WAN
/interface list member add interface=vAMSIX-BKK list=WAN
/interface list member add interface=vAMSIX-HK list=WAN
/interface list member add interface=vHGC-SG-PRIMARY list=WAN
/interface list member add interface=vHGC-HK-BACKUP list=WAN
...
/ip address add address=118.143.234.74/29 interface=vHGC-SG-PRIMARY network=118.143.234.72
...
/ip address add address=103.100.140.31/24 interface=vAMSIX-BKK network=103.100.140.0
/ip address add address=103.247.139.76/25 interface=vAMSIX-HK network=103.247.139.0
...
/ip address add address=103.168.174.178/30 interface=vHGC-HK-BACKUP network=103.168.174.176
...
/ip route add comment="RTR src fix: BKNIX validator via HGC-SG (was via bkk00 BKNIX, port down 2026-07)" disabled=no dst-address=203.159.70.26/32 gateway=118.143.234.73 pref-src=160.22.181.178
...
/ipv6 address add address=2403:5000:165:15::2 advertise=no interface=vHGC-SG-PRIMARY
/ipv6 address add address=2402:b740:15:388:a500:14:2108:1 advertise=no interface=vAMSIX-BKK
/ipv6 address add address=2001:df0:296:0:a500:14:2108:1 advertise=no interface=vAMSIX-HK
/ipv6 address add address=fd00:dead:beef::20/128 advertise=no interface=lo
/ipv6 address add address=2407:9540:111:7::2/126 advertise=no interface=vHGC-HK-BACKUP
...
/ipv6 address add address=fd00:155:206::/127 advertise=no disabled=yes interface=*7A
/ipv6 address add address=fd00:155:207::/127 advertise=no disabled=yes interface=*79
/ipv6 address add address=fd00:155:208::/127 advertise=no disabled=yes interface=*78
/ipv6 address add address=fd00:155:100::2 advertise=no comment="BGP RR unified\
    \n   network" interface=qnq-400-100
...
/routing bgp connection add afi=ip disabled=no input.limit-process-routes-ipv4=5000000 .limit-process-routes-ipv6=5000000 instance=bgp-instance-1 local.address=103.100.140.31 .role=ebgp multihop=yes name=AMSIX-RS1-TH-v4 remote.address=103.100.140.251 .as=150388 routing-table=main templates=AMSIX-BAN-v4
/routing bgp connection add afi=ip disabled=no input.limit-process-routes-ipv4=5000000 instance=bgp-instance-1 local.address=103.100.140.31 .role=ebgp multihop=yes name=AMSIX-RS2-TH-v4 remote.address=103.100.140.252 .as=150388 routing-table=main templates=AMSIX-BAN-v4
/routing bgp connection add afi=ipv6 input.limit-process-routes-ipv6=5000000 instance=bgp-instance-1 local.address=2402:b740:15:388:a500:14:2108:1 .role=ebgp multihop=yes name=AMSIX-RS1-TH-v6 remote.address=2402:b740:15:388:a500:15:388:251 .as=150388 routing-table=main templates=AMSIX-BAN-v6
/routing bgp connection add afi=ipv6 input.limit-process-routes-ipv6=5000000 instance=bgp-instance-1 local.address=2402:b740:15:388:a500:14:2108:1 .role=ebgp multihop=yes name=AMSIX-RS2-TH-v6 output.redistribute=connected,static,bgp remote.address=2402:b740:15:388:a500:15:388:252 .as=150388 routing-table=main templates=AMSIX-BAN-v6
/routing bgp connection add afi=ip disabled=no input.limit-process-routes-ipv4=5000000 instance=bgp-instance-1 local.address=103.247.139.76 .role=ebgp multihop=no name=AMSIX-HE-HK-v4 remote.address=103.247.139.6 .as=6939 routing-table=main templates=AMSIX-HK-v4
...
/routing bgp connection add afi=ipv6 input.limit-process-routes-ipv6=5000000 instance=bgp-instance-1 local.address=2001:df0:296:0:a500:14:2108:1 .role=ebgp multihop=yes name=AMSIX-RS1-HK-v6 remote.address=2001:df0:296::a505:8560:1 .as=58560 routing-table=main templates=AMSIX-HK-v6
/routing bgp connection add afi=ipv6 input.limit-process-routes-ipv6=5000000 instance=bgp-instance-1 local.address=2001:df0:296:0:a500:14:2108:1 .role=ebgp multihop=yes name=AMSIX-RS2-HK-v6 remote.address=2001:df0:296::a505:8560:2 .as=58560 routing-table=main templates=AMSIX-HK-v6
...
/routing filter rule add chain=AMSIX-BAN-IN-v6 comment="Discard overly specific prefixes" disabled=no rule="if (dst-len > 40) { reject; }"
...
/routing filter rule add chain=AMSIX-HK-IN-v4 comment="Reject RPKI invalid routes" disabled=no rule="if (rpki invalid) { reject; }"
...
/routing filter rule add chain=AMSIX-HK-IN-v6 comment="Discard overly specific IPv6 prefixes" rule="if (dst-len > 40) { reject; }"
/routing filter rule add chain=AMSIX-HK-IN-v6 comment="RPKI validation" disabled=no rule="rpki-verify rpki.bknix.co.th"
/routing filter rule add chain=AMSIX-HK-IN-v6 comment="Reject RPKI invalid routes" disabled=no rule="if (rpki invalid) { reject; }"
/routing filter rule add chain=AMSIX-HK-IN-v6 comment="Discard default route" rule="if (dst == ::/0) { reject; }"
/routing filter rule add chain=AMSIX-BAN-IN-v4 comment="RFC7607 reject AS 0" rule="if (bgp-as-path [0]) { reject; }"
/routing filter rule add chain=AMSIX-BAN-IN-v4 comment="Reject private ASN 16bit" rule="if (bgp-as-path [64512-65535]) { reject; }"
/routing filter rule add chain=AMSIX-BAN-IN-v4 comment="Reject private ASN 32bit" rule="if (bgp-as-path [4200000000-4294967295]) { reject; }"
/routing filter rule add chain=AMSIX-BAN-IN-v4 comment="AS-path too long" rule="if (bgp-path-len > 75) { reject; }"
/routing filter rule add chain=AMSIX-BAN-IN-v4 comment="Accept route v4" rule="set bgp-large-communities amsix-ban-communities; set bgp-local-pref 200; accept"
...
/routing filter rule add chain=HGC-SG-IN-v4 comment="Accept route v4" rule="set bgp-large-communities hgc-sg-communities; set bgp-local-pref 150; accept"
/routing filter rule add chain=AMSIX-HK-IN-v4 comment="RFC7607 reject AS 0" rule="if (bgp-as-path [0]) { reject; }"
/routing filter rule add chain=AMSIX-HK-IN-v4 comment="Reject private ASN 16bit" rule="if (bgp-as-path [64512-65535]) { reject; }"
/routing filter rule add chain=AMSIX-HK-IN-v4 comment="Reject private ASN 32bit" rule="if (bgp-as-path [4200000000-4294967295]) { reject; }"
/routing filter rule add chain=AMSIX-HK-IN-v4 comment="AS-path too long" rule="if (bgp-path-len > 75) { reject; }"
/routing filter rule add chain=AMSIX-HK-IN-v4 comment="Accept route v4" rule="set bgp-large-communities amsix-hk-communities; set bgp-local-pref 180; accept"
...
/routing filter rule add chain=AMSIX-BAN-IN-v6 comment="RFC7607 reject AS 0" rule="if (bgp-as-path [0]) { reject; }"
/routing filter rule add chain=AMSIX-BAN-IN-v6 comment="Reject private ASN 16bit" rule="if (bgp-as-path [64512-65535]) { reject; }"
/routing filter rule add chain=AMSIX-BAN-IN-v6 comment="Reject private ASN 32bit" rule="if (bgp-as-path [4200000000-4294967295]) { reject; }"
/routing filter rule add chain=AMSIX-BAN-IN-v6 comment="AS-path too long" rule="if (bgp-path-len > 75) { reject; }"
/routing filter rule add chain=AMSIX-BAN-IN-v6 comment="Accept route v6" rule="set bgp-large-communities amsix-ban-communities; set bgp-local-pref 200; accept"
...
/routing filter rule add chain=HGC-SG-IN-v6 comment="Accept route v6" rule="set bgp-large-communities hgc-sg-communities; set bgp-local-pref 150; accept"
/routing filter rule add chain=AMSIX-HK-IN-v6 comment="Reject our own prefixes" rule="if (dst in ipv6-apnic-rotko) { reject; }"
/routing filter rule add chain=AMSIX-HK-IN-v6 comment="RFC7607 reject AS 0" rule="if (bgp-as-path [0]) { reject; }"
/routing filter rule add chain=AMSIX-HK-IN-v6 comment="Reject private ASN 16bit" rule="if (bgp-as-path [64512-65535]) { reject; }"
/routing filter rule add chain=AMSIX-HK-IN-v6 comment="Reject private ASN 32bit" rule="if (bgp-as-path [4200000000-4294967295]) { reject; }"
/routing filter rule add chain=AMSIX-HK-IN-v6 comment="AS-path too long" rule="if (bgp-path-len > 75) { reject; }"
/routing filter rule add chain=AMSIX-HK-IN-v6 comment="Accept route v6" rule="set bgp-large-communities amsix-hk-communities; set bgp-local-pref 180; accept"
...
/routing filter rule add chain=IBGP-IN-v6 rule="if (bgp-large-communities includes-list amsix-hk-communities) { set bgp-local-pref 180; }"
...
/routing filter rule add chain=ROUTEVIEWS-OUT-v4 comment=RPKI-invalid disabled=yes rule="if (rpki invalid) { reject; }"
