# 2025-05-19 13:42:17 by RouterOS 7.19rc2
...
/interface bonding add lacp-rate=1sec mode=802.3ad name=BKK00-LAG slaves=qsfp28-1-1,qsfp28-2-1 transmit-hash-policy=layer-2-and-3
/interface bonding add comment=bkk10-sfp3 disabled=yes lacp-rate=1sec mode=802.3ad name=BKK10-LAG slaves=sfp28-5 transmit-hash-policy=layer-2-and-3
...
/routing bgp template add afi=ipv6 as=142108 input.filter=iBGP-IN multihop=yes name=IBGP-ROTKO-v6 nexthop-choice=default output.filter-chain=iBGP-OUT .network=ipv6-apnic-rotko .redistribute=connected router-id=10.155.255.1
...
/ipv6 route add comment="static route for bknix rkpi via bkk00" distance=5 dst-address=2001:deb:0:4070::/64 gateway=BKK00-LAG
...
/ipv6 firewall raw add action=drop chain=prerouting comment=BGP-MAINTENANCE-MODE-AMSIX disabled=yes dst-address=2001:7f8:1::/64 port=179 protocol=tcp src-address=2001:7f8:1::/64
...
/ipv6 firewall raw add action=accept chain=prerouting comment="Allow RPKI replies from bknix.co.th IPv6" protocol=tcp src-address=2001:deb:0:4070::26/128 src-port=323
/ipv6 firewall raw add action=accept chain=prerouting comment="Allow RPKI replies from bknix.net IPv6" protocol=tcp src-address=2001:deb:0:4070::36/128 src-port=4323
...
/routing bgp connection add afi=ipv6 disabled=no input.limit-process-routes-ipv4=3000000 .limit-process-routes-ipv6=3000000 local.role=ebgp multihop=no name=HGC-SG-PRIMARY-v6 remote.address=2403:5000:165:15::1 .as=9304 routing-table=main templates=HGC-SG-v6
/routing bgp connection add afi=ip as=142108 disabled=no input.limit-process-routes-ipv4=3000000 .limit-process-routes-ipv6=3000000 local.role=ebgp multihop=no name=HGC-SG-PRIMARY-v4 remote.address=118.143.234.73 .as=9304 routing-table=main templates=HGC-SG-v4
...
/routing bgp connection add as=142108 local.address=103.247.139.76 .role=ebgp multihop=yes name=AMSIX-HGC-HK-v4 remote.address=103.247.139.39 .as=9304 routing-table=main templates=AMSIX-HK-v4
/routing bgp connection add as=142108 local.address=2001:df0:296:0:a500:14:2108:1 .role=ebgp multihop=yes name=AMSIX-HGC-HK-v6 remote.address=2001:df0:296::a500:9304:1 .as=9304 routing-table=main templates=AMSIX-HK-v6
/routing bgp connection add as=142108 local.address=103.100.140.31 .role=ebgp multihop=yes name=AMSIX-HGC-TH-v4 remote.address=103.100.140.47 .as=9304 routing-table=main templates=AMSIX-BAN-v4
/routing bgp connection add as=142108 local.address=2402:b740:15:388:a500:14:2108:1 .role=ebgp multihop=yes name=AMSIX-HGC-TH-v6 remote.address=2402:b740:15:388:0:a500:9304:1 .as=9304 routing-table=main templates=AMSIX-BAN-v6
/routing bgp connection add as=142108 comment="Disabled due to AS_TRANS issue in RouterOS 7.19beta8" disabled=yes local.address=103.100.140.31 .role=ebgp multihop=yes name=AMSIX-HGCTH-TH-v4 remote.address=103.100.140.98 .as=142435 routing-table=main templates=AMSIX-BAN-v4
/routing bgp connection add as=142108 comment="Disabled due to AS_TRANS issue in RouterOS 7.19beta8" disabled=yes local.address=2402:b740:15:388:a500:14:2108:1 .role=ebgp multihop=yes name=AMSIX-HGCTH-TH-v6 remote.address=2402:b740:15:388:a500:14:2435:1 .as=142435 routing-table=main templates=AMSIX-BAN-v6
...
/routing bgp connection add afi=ipv6 as=142108 disabled=no input.filter=iBGP-IN .limit-process-routes-ipv6=2000000 local.address=fd00:dead:beef::20 .role=ibgp name=IBGP-ROTKO-BKK00-v6 nexthop-choice=default output.filter-chain=iBGP-OUT .keep-sent-attributes=yes .redistribute=connected,bgp remote.address=fd00:dead:beef::100 .as=142108 router-id=10.155.255.2 routing-table=main templates=IBGP-ROTKO-v6
